 ...
 navbarPage("Online Film Consulting",
  ...
  checkboxGroupInput("select", label = h3("3. Select genre"), 
    ...
    selectInput("radio", label = h3("4. Select Budget"),
                 choices = list("$5 million +" = "C_Marketing_Template v3.pdf",
                                "$3 million - $5 million" = "B_Marketing_Template v3.pdf",
                                "$1 million - $3 million" = "B_Marketing_Template v3.pdf",
                                "$250K - $1 million" = "B_Marketing_Template v3.pdf",
                                 "Under $250K" = "A_Marketing_Template v3.pdf")), 
